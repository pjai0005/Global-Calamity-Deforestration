...
```{r structure,eval=TRUE,echo=FALSE}
library(tidyverse)
library(kableExtra)
...
```
According to the figure \@ref(...) above, it is obvious that the most productive crop oil is palm oil, followed by soybean oil and then rapeseed. We found it to be intriguing that how palm oil’s production outstands the rest of the vegetable oils so dominantly. 
...
```
The line graph \@ref(fig:) demonstrates the timeline of various types of crop oil production from 1961 to 2014. It seems that the production of palm oil shows a significant upward trend and outstands other crop oil’s production. 
